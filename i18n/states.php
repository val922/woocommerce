...
return array(
	...
	'BW' => array( // Botswana districts.
		'GeC' => __( 'Gaborone City', 'woocommerce' ),
		'FtC' => __( 'Francistown City', 'woocommerce' ),
		'LeT' => __( 'Lobatse Town', 'woocommerce' ),
		'SpT' => __( 'Selebi-Phikwe Town', 'woocommerce' ),
		'JwT' => __( 'Jwaneng Town', 'woocommerce' ),
		'OpT' => __( 'Orapa Town', 'woocommerce' ),
		'SwT' => __( 'Sowa Township	', 'woocommerce' ),
		'SnD' => __( 'Southern District', 'woocommerce' ),
		'SeD' => __( 'South-East District', 'woocommerce' ),
		'KwD' => __( 'Kweneng District', 'woocommerce' ),
		'KgD' => __( 'Kgatleng District	', 'woocommerce' ),
		'ChD' => __( 'Central District', 'woocommerce' ),
		'NeD' => __( 'North-East District', 'woocommerce' ),
		'NdD' => __( 'Ngamiland District', 'woocommerce' ),
		'CeD' => __( 'Chobe District', 'woocommerce' ),
		'GzD' => __( 'Ghanzi District', 'woocommerce' ),
		'KdD' => __( 'Kgalagadi District', 'woocommerce' ),
	),
